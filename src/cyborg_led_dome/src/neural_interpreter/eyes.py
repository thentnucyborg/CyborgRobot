...
class Eyes():
	...
	def render(self,input_data, output_data):
		if self.count == self.blink:
			# the eyes - turn off some leds
			# left eye
			output_data[420*3+2] = 0
			output_data[421*3+2] = 0
			output_data[422*3+2] = 0
			output_data[423*3+2] = 0

			output_data[444*3+2] = 0
			output_data[447*3+2] = 0

			# right eye
			output_data[410*3+2] = 0
			output_data[411*3+2] = 0
			output_data[412*3+2] = 0
			output_data[413*3+2] = 0

			output_data[454*3+2] = 0
			output_data[457*3+2] = 0
			...
			### the eyes ###
			# left eye
			output_data[420*3+2] = 50
			output_data[421*3+2] = 100
			output_data[422*3+2] = 100
			output_data[423*3+2] = 50

			output_data[443*3+2] = 50
			output_data[444*3+2] = 100
			output_data[447*3+2] = 100
			...
			# right eye
			output_data[410*3+2] = 50
			output_data[411*3+2] = 100
			output_data[412*3+2] = 100
			output_data[413*3+2] = 10

			output_data[453*3+2] = 50
			output_data[454*3+2] = 100
			output_data[457*3+2] = 100
