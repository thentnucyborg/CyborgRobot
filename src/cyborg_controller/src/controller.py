...
def main():
    ...
    path = homedir + "/catkin_ws/src/cyborg_navigation/src/controller.db"
    ...
    with sm:
        ...
        startup_transitions = {"succeeded":"suspension",
                            "aborted":"suspension"}
        startup_resources = {}
        smach.StateMachine.add("startup",
                            Module("startup", "cyborg_behavior", startup_transitions, startup_resources),
                            startup_transitions,
                            sm_remapping)
