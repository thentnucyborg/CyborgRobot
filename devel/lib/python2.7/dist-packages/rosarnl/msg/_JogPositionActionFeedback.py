...
"""autogenerated by genpy from rosarnl/JogPositionActionFeedback.msg. Do not edit."""
import sys
...
class JogPositionActionFeedback(genpy.Message):
  _md5sum = "3f71f32af2058e3162a01a2927e7eb37"
  _type = "rosarnl/JogPositionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosarnl/JogPositionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JogPositionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rosarnl.msg.JogPositionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rosarnl.msg.JogPositionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3d2i().pack(_x.feedback.current.x, _x.feedback.current.y, _x.feedback.current.theta, _x.feedback.duration.secs, _x.feedback.duration.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.current.x, _x.feedback.current.y, _x.feedback.current.theta, _x.feedback.duration.secs, _x.feedback.duration.nsecs,) = _get_struct_3d2i().unpack(str[start:end])
      return self
