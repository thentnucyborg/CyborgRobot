...
"""autogenerated by genpy from rosarnl/JogPositionActionResult.msg. Do not edit."""
import sys
...
class JogPositionActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "rosarnl/JogPositionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosarnl/JogPositionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JogPositionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rosarnl.msg.JogPositionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rosarnl.msg.JogPositionResult()
