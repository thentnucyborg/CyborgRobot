...
let StateMachineGoal = require('./StateMachineGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class StateMachineActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new StateMachineGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StateMachineGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += StateMachineGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StateMachineActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = StateMachineGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new StateMachineGoal()
    }
...
module.exports = StateMachineActionGoal;
