...
let JogPositionFeedback = require('./JogPositionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class JogPositionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new JogPositionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JogPositionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JogPositionActionFeedback(null);
    ...
    data.feedback = JogPositionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JogPositionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = JogPositionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new JogPositionFeedback()
    }
...
module.exports = JogPositionActionFeedback;
